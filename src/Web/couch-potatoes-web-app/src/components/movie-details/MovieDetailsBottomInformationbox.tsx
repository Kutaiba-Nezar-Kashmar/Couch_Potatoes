					...
					<Stack divider={<StackDivider/>} spacing='2'>
						<Box >
							...
							<Stack  direction="row"  spacing='8'>
								<Stack>
									<Heading textTransform='uppercase' size='sm'>Director(s)</Heading>
									<Stack  >
										{movieCredits && movieCredits?.creditsAsCrew.filter(crew => crew.job === "Director")
											.map(crew => (
												<Link
													color={themeColor}
													_hover={{color: "grey"}}
								...
								<Stack>
									<Heading textTransform='uppercase' size='sm'>Screenplay</Heading>
									<Stack  >
										{movieCredits && movieCredits?.creditsAsCrew.filter(crew => crew.job === "Screenplay")
											.map(crew => (
												<Link
													color={themeColor}
													_hover={{color: "grey"}}
								...
								<Text padding={0}  textTransform='uppercase' size='sm'>
									<Link
										color={themeColor}
										_hover={{color: "grey"}}
										href="https://example.com"
